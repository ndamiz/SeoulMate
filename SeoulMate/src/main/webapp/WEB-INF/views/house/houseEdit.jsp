...
<div class="wrap">
	...
	<p>&nbsp;</p>
		...
		<p>&nbsp;</p>
			...
			<ul class="form_box">
				<li> <label>게재 기간 </label> <input type="date" name="" /> </li>
			...
			<label>총 욕실 수</label>	<select name="bathroom">
						<option value="1">1</option>
						<option value="2">2</option>
						<option value="3">3</option>
						<option value="4">4</option>
			...
			<label>찾는 인원</label> <select name="searchPeople">
						<option value="1">1</option>
						<option value="2">2</option>
...
<!-- 			<button id="roomPlus" class="green" >방 추가등록 </button> <br/>  -->
		...
		<div class="title_wrap">
		<p class="s_title">사진 등록 </p> <br/> <!-- 5개까지 등록 가능 -->
		<p>&nbsp;</p>
		</div>
