...
<%-- 	<input type="hidden" name="no" value="${rVO. hno }"> --%>
	...
	<!--                <input type="file" accept="image/*" name="filename"  id="housepic1" onchange="readURL(this);" />  -->
		...
		<c:forEach var="idx" begin="${rVO_ListSize}" end="3" varStatus="i">
			<div class="room${rVO_ListSize+i.count}">
				<br><br>
				<div class="title_wrap">
					<p class="s_title">${rVO_ListSize+i.count}번 방 임대료 및 입주정보 </p> <br/>
					<p>&nbsp;</p>
				</div><br><br>
